                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col lg:flex-row">
                                    <input type="email" placeholder="username@site.com" className="flex-grow p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
                                    <button className="ml-2 bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-900 transition duration-300">Subscribe</button>
                                </div>
                            </div>
                            <div>
